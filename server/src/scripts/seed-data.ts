// Initial content, ported verbatim from the old hardcoded lib/content.ts so the
// live /blog output is byte-identical after the backend split.
//
// This is a bootstrap fixture, NOT the source of truth — once seeded, the
// dashboard owns these rows. Editing this file will not change a live post.
